                ...
                <div class="content">
                  ...
                  <form id="login-form" action="admin" method="post">
                    <div class="form-group">
                      <input id="lemail" type="text" name="auser" required class="input-material">
                      <label for="lemail" class="label-material">Username</label>
                    </div>
                    <div class="form-group">
                      <input id="lpass" type="password" name="apass" required class="input-material">
